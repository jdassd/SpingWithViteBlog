...
import com.springwithviteblog.service.PhotoSyncService;
...
public class AdminAlbumController {
  ...
  public AdminAlbumController(AlbumService albumService, PhotoSyncService photoSyncService, UserService userService) {
  ...
  public ApiResponse<PhotoDto> upload(@PathVariable Long id,
    ...
    return ApiResponse.ok(albumService.uploadPhoto(id, currentUser(), file, autoSync));
  }
  ...
  @PostMapping("/photos/{photoId}/sync")
  public ApiResponse<Object> syncPhoto(@PathVariable Long photoId) {
    photoSyncService.enqueueSync(photoId);
    return ApiResponse.ok(null);
  }

  @PostMapping("/git/test")
  public ApiResponse<Object> testGitConnection() {
    photoSyncService.testConnection();
    return ApiResponse.ok(null);
  }
