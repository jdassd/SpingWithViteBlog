...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'me/favorites', name: 'my-favorites', component: () => import('@/views/Favorites.vue'), meta: { requiresAuth: true, title: 'My Favorites' } },
      { path: 'series', name: 'series-list', component: () => import('@/views/SeriesList.vue'), meta: { title: 'Series' } },
      { path: 'series/:id', name: 'series-detail', component: () => import('@/views/SeriesDetail.vue'), meta: { title: 'Series' } },
      { path: 'ranking', name: 'ranking', component: () => import('@/views/Ranking.vue'), meta: { title: 'Ranking' } },
      { path: 'links', name: 'friend-links', component: () => import('@/views/FriendLinks.vue'), meta: { title: 'Links' } },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'series', component: () => import('@/views/admin/Series.vue'), meta: { title: 'Series' } },
      { path: 'series/new', component: () => import('@/views/admin/SeriesEditor.vue'), meta: { title: 'New Series' } },
      { path: 'series/:id', component: () => import('@/views/admin/SeriesEditor.vue'), meta: { title: 'Edit Series' } },
      { path: 'analytics', component: () => import('@/views/admin/Analytics.vue'), meta: { title: 'Analytics' } },
      { path: 'friend-links', component: () => import('@/views/admin/FriendLinks.vue'), meta: { title: 'Friend Links' } },
    ],
  },
